...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 16 sep. 2022 à 09:03
...
--
-- Déchargement des données de la table `asso_9`
--

INSERT INTO `asso_9` (`codeetudiant`, `classecode`) VALUES
(1, 4),
(2, 6),
(3, 12),
(4, 3),
...
(2, 'SAINSOULIEU', 'Stephane', 'test', 2),
(3, 'NOM_enseignant', 'Prenom_enseignant', '', 2),
(4, 'nom', 'prenom', '', 2);
