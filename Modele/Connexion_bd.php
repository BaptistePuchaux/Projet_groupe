...
function connexion() {
    try {
        ...
        if (empty($_SESSION['connectperm'])){
            $conn = new PDO('mysql:host=localhost;port=3306;dbname=livret', 'user', '');
        }else if ($_SESSION['connectperm'] == 2){
            $conn = new PDO('mysql:host=localhost;port=3306;dbname=livret', 'prof', 'Rynax2022');
        }else if ($_SESSION['connectperm'] == 4){
            $conn = new PDO('mysql:host=localhost;port=3306;dbname=livret', 'admin', 'Rynax06000');
        }else if ($_SESSION['connectperm'] == 5){
